...
module.exports = function( grunt ) {
    ...
    function convert( name, path, contents ) {
        ...
        if ( /.\/var\//.test( path ) ) {
            ...
            // Ignore mjp's return statement (the only necessary one)
            if ( name !== "mjp" ) {
                contents = contents
    ...
    function() {
        var flag,
            ...
            if ( !optIn ) {
                ...
                config.rawText.mjp = "define([" + (included.length ? included.join(",") : "") + "]);";
            }
        ...
        grunt.registerTask( "custom", function() {
            ...
            grunt.task.run([ "build:*:*:" + modules, "pre-uglify", "uglify", "dist", "compare_size" ]);
        });
    };
